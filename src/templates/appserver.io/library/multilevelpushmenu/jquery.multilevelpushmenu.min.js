(function (a) {
    a.fn.multilevelpushmenu = function (c) {
        var b = arguments, d = null;
        this.each(function () {
            var P = this, r = a(this), n = (r.context != undefined) ? r : a("body"), W = (c && c.menu != undefined) ? c.menu : r.find("nav"), L, g;
            var U = a.extend({
                container: n,
            ...
            function k(Y, Z) {
                ...
                Y.on(Z, function (ad, aa) {
                    Y.hide();
                    try {
                        aa = aa || {pageX: ad.pageX, pageY: ad.pageY};
            ...
            function e(Z, Y) {
                ...
                a.each(Z, function () {
                    ...
                    }).appendTo(Y), aa = (C(P.settings.menuWidth) || (T(P.settings.menuWidth) && P.settings.menuWidth > 0));
                    ...
                    var ac = a("<h2 />").attr({style: "text-align: " + ((P.settings.direction == "rtl") ? "right" : "left")}).text(this.title).appendTo(ae), ab = a("<i />").prop({"class": ((P.settings.direction == "rtl") ? "floatLeft" : "floatRight") + " cursorPointer " + this.icon}).prependTo(ac);
            ...
            function v() {
                ...
                Y.prop({id: P.settings.menuID, className: P.settings.wrapperClass});
                t(Y)
            }
            ...
            function t(Y) {
                ...
                a.each(Y, function () {
                    ...
                    }).appendTo(Y), Z = (C(P.settings.menuWidth) || (T(P.settings.menuWidth) && P.settings.menuWidth > 0));
                    ad.bind(g, function (ae) {
                        O(ae, ad)
                    });
                    var ab = Y.children("h2");
                    ab.attr({style: "text-align: " + ((P.settings.direction == "rtl") ? "right" : "left")});
                    ab.appendTo(ad);
                    ...
                    a.each(ac.children("li"), function () {
                        var af = a(this);
                        af.attr({style: "text-align: " + ((P.settings.direction == "rtl") ? "right" : "left")});
            ...
            function I(ab) {
                var Y = a("<div />").attr({"class": P.settings.backItemClass}).appendTo(ab), Z = a("<a />").prop({href: "#"}).text(P.settings.backText).appendTo(Y), aa = a("<i />").prop({"class": ((P.settings.direction == "rtl") ? "floatLeft " : "floatRight ") + P.settings.backItemIcon}).prependTo(Z);
            ...
            function o(Y) {
                var Z = a("<i />").attr({"class": ((P.settings.direction == "rtl") ? " floatRight iconSpacing_rtl " : " floatLeft iconSpacing_ltr ") + P.settings.groupIcon}).prependTo(Y)
            }

            function V() {
                var ab = arguments[0], ae = arguments[1], Y = arguments[2], ad = ae.find("ul:first"), aa = a("<li />");
                (Y < (ad.find("li").length) && Y >= 0) ? aa.insertBefore(ad.find("li").eq(Y)) : aa.appendTo(ad);
                aa.attr({style: "text-align: " + ((P.settings.direction == "rtl") ? "right" : "left")});
                if (ab.id != undefined) {
                    aa.attr({id: ab.id})
                }
                var Z = a("<a />").prop({href: ab.link}).text(ab.name).appendTo(aa), ac = a("<i />").prop({"class": ((P.settings.direction == "rtl") ? "floatLeft " : "floatRight ") + ab.icon}).prependTo(Z);
                if (ab.items) {
            ...
            function S() {
                if (!P.redraw) {
                    P.redraw = true;
                    var aa = arguments[0], ad = arguments[1], Z = arguments[2], ac = (a("#" + P.settings.menuID + " div.levelHolderClass").first().css("filter").match(/DXImageTransform\.Microsoft\.Shadow/)) ? a("#" + P.settings.menuID + " div.levelHolderClass").first().get(0).filters.item("DXImageTransform.Microsoft.Shadow").strength : 0, ao = (aa == undefined) ? Math.max.apply(null, a("#" + P.settings.menuID + " div.levelHolderClass").map(function () {
                        return a(this).width()
                    }).get()) - ac : aa - ac, al = Math.max.apply(null, a("#" + P.settings.menuID + " div.levelHolderClass").map(function () {
                        return a(this).attr("data-level")
                    }).get()), ai = (C(P.settings.menuWidth) || (T(P.settings.menuWidth) && P.settings.menuWidth > 0)), ab = (C(P.settings.menuHeight) || (T(P.settings.menuHeight) && P.settings.menuHeight > 0)), af = (Z == undefined) ? a("#" + P.settings.menuID + " div.levelHolderClass") : Z, aj;
                    ...
                    var ah = (ai && aa == undefined) ? (af.width() - ac + al * (P.settings.overlapWidth + ac)) : (ao + al * (P.settings.overlapWidth + ac)), an = (ad == undefined) ? Math.max.apply(null, a("#" + P.settings.menuID + " div.levelHolderClass").map(function () {
                    ...
                    var ak = a("#" + P.settings.menuID + " div.levelHolderClass:first"), am = i(), ae = p(), Y = K(), ag = (Y.length == 1) ? Y.attr("data-level") : 0;
                    if (am) {
                        am.each(function () {
            ...
            function E() {
                var Z = a("#" + P.settings.menuID + " div.levelHolderClass:first"), Y = P.settings.container.find("#" + P.settings.menuID + " div.levelHolderClass").filter(function () {
            ...
            function A(Z) {
                if (Z) {
                    ...
                    if (P.settings.direction == "rtl") {
                        Y.stop().animate({marginRight: ((-1) * Y.width() + ((P.settings.fullCollapse) ? 0 : P.settings.overlapWidth))})
                    } else {
                        Y.stop().animate({marginLeft: ((-1) * Y.width() + ((P.settings.fullCollapse) ? 0 : P.settings.overlapWidth))})
                    }
                }
            }
            ...
            function D(Y) {
                ...
                a.each(P.settings.containersToPush, function () {
                    var aa = parseInt(a(this).css("margin-left")), ab = T(aa) ? aa : 0, Z = parseInt(a(this).css("margin-right")), ac = T(Z) ? Z : 0;
                    a(this).stop().animate({
            ...
            function F() {
                ...
                var Z = arguments[0], ai = arguments[1], ad = {}, aa, ab, ac, al, aj, ak = a("#" + P.settings.menuID + " div.levelHolderClass:first"), ag = (Z == undefined) ? true : false, ah;
                ...
                if (ai == undefined && typeof ai != "object") {
                    ai = [
                        {method: P.settings.onCollapseMenuEnd, args: [P.settings]}
                    ]
                } else {
                    a.merge(ai, [
                        {method: P.settings.onCollapseMenuEnd, args: [P.settings]}
                ...
                if (ae.length > 0) {
                    ...
                    af.each(function (am, an) {
                        ...
                        if (P.settings.direction == "rtl") {
                            a(an).stop().animate({marginRight: ((-1) * ab), width: ab})
                        } else {
                            a(an).stop().animate({marginLeft: ((-1) * ab), width: ab})
                        }
                    });
            ...
            function x() {
                ...
                var ab = arguments[0], ao = arguments[1], af, am, ap, an, Y, al = {}, Z = a("#" + P.settings.menuID + " div.levelHolderClass:first"), ai = (ab == undefined) ? true : false, aa = (P.settings.direction == "rtl") ? parseInt(Z.css("margin-right"), 10) < 0 || Z.position().left >= P.settings.container.width() - P.settings.overlapWidth : parseInt(Z.css("margin-left"), 10) < 0 || Z.position().left < 0;
                al.expandingEnded = false;
                if (ao == undefined && typeof ao != "object") {
                    ao = [
                        {method: P.settings.onExpandMenuEnd, args: [P.settings]}
                    ]
                } else {
                    a.merge(ao, [
                        {method: P.settings.onExpandMenuEnd, args: [P.settings]}
                ...
                if (ai) {
                    ...
                    if (P.settings.direction == "rtl") {
                        Z.stop().animate({marginRight: 0}, function () {
                        ...
                        Z.stop().animate({marginLeft: 0}, function () {
                            Z.children("ul").first().show(500, function () {
                                al.baseAnimEnded = true;
                                J(al, ao)
                            })
                    ...
                    if (ag && ag.length == 1) {
                        var ac = K(), ad = (ac.length == 1) ? ac.attr("data-level") : 0, ak = ag.width(), aj = s(ag);
            ...
            function u() {
                var ad = arguments[0], aa, Z = K(), ac, Y, ab;
                if (typeof ad == "object") {
                    aa = ad
                } else {
                    if (typeof ad == "string") {
            ...
            function Q() {
                var Y = arguments[0], Z, aa = P.settings.container.find("#" + P.settings.menuID + " div.levelHolderClass").filter(function () {
            ...
            function R() {
                var aa = arguments[0], Y, Z = P.settings.container.find("#" + P.settings.menuID + " div.levelHolderClass li").filter(function () {
            ...
            function B() {
                var ah = arguments[0], af = arguments[1], ae = (arguments[2] != undefined) ? arguments[2] : false, ad, aa, ac, ab, ai, Z, ag, Y;
            ...
            function G() {
                var Z = arguments[0], ab = arguments[1], Y = arguments[2];
